...
function ModalBody({ data, toggle, isInActive, onToggleStatus }) {
  return (
    <Modal.Body className="px-lg-5 pt-lg-4">
      ...
      <div className="top d-flex align-items-center justify-content-between gap-10 pb-3">
        <div className="d-flex align-items-center profile gap-10">
          <div className="imgWrp">
            <img
              src={data?.media?.[0]?.media || "/assets/images/dog-placeholder.png"}
              alt=""
          ...
          <div className="content">
            <h5 className="m-0 fw-bold py-2">{data.contest_name}</h5>
            <p className="m-0">
        ...
        <div className="right">
          <span
            className={classNames(" fw-sbold statusLabel px-3 py-2", {
              successLabel: !isInActive,
              dangerLabel: isInActive,
            })}
          >
      ...
      <div className="py-2">
        <h6 className="m-0 py-2 fw-sbold">Contest Information</h6>
        <ul className="list-unstyled p s-0 mb-0 listing">
          <li className="d-flex align-items-start gap-10 py-1">
            <span className=" fw-sbold text-muted">Question:</span>
            <span className=" fw-sbold text-dark">{data.question_title}</span>
          </li>
          <li className="d-flex align-items-start gap-10 py-1">
            <span className=" fw-sbold text-muted">Description:</span>
            <span className=" fw-sbold text-dark">{data.description}</span>
          </li>
          <li className="d-flex align-items-start gap-10 py-1">
            <span className=" fw-sbold text-muted">Participation Fees:</span>
            <span className=" fw-sbold text-dark">
              {data.participation_fee}
            </span>
          </li>
          <li className="d-flex align-items-start gap-10 py-1">
            <span className=" fw-sbold text-muted">Max Winners:</span>
            <span className=" fw-sbold text-dark">
              {data.number_of_winners}
            </span>
          </li>
          <li className="d-flex align-items-start gap-10 py-1">
            <span className=" fw-sbold text-muted">Website:</span>
            <span className=" fw-sbold text-dark">
              {data.website_and_address}
            </span>
          </li>
          <li className="d-flex align-items-start gap-10 py-1">
            <span className=" fw-sbold text-muted">Auto Creation:</span>
            <span className=" fw-sbold text-dark">
              {data.auto_creation ? "Yes" : "No"}
            </span>
          </li>
        </ul>
        <div className="btnWrp mt-3" onClick={() => onToggleStatus(data._id)}>
